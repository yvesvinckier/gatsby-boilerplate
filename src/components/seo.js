...
const defaultTitle =
    'Jean Emmanuel Rode Photographe à Lille | NORD | HAUTS-DE-FRANCE | 59'
const defaultDescription =
    'Jean Emmanuel RODE - Photographe professionnel installé à Lille (NORD 59), spécialisé en photographie culinaire, nature morte, décoration, institutionnel et spectacle.'
